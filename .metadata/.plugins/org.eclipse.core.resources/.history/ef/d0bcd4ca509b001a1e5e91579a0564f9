...
<div class="w3-bar w3-white w3-large" id="nav">
  <a href="index.jsp" class="w3-bar-item w3-button w3-red w3-mobile"><i class="fa fa-bed w3-margin-right"></i>SIST RENTCAR</a>
  <a href="#rooms" class="w3-bar-item w3-button w3-mobile">예약</a>
  <a href="#about" class="w3-bar-item w3-button w3-mobile">게시판</a>
  <a href="#contact" class="w3-bar-item w3-button w3-mobile">마이페이지</a>
  <a href="#contact" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">회원가입</a>
  <a href="#contact" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">로그인</a>
</div>
<!-- Header -->
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="image/bg.jpg" alt="배경화면" style="min-width:1000px" width="1500" height="800">
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-bed w3-margin-right"></i>SIST RENTCAR</h2>
    </div>
    <div class="w3-container w3-white w3-padding-16">
      <form action="/action_page.php" target="_blank">
        <div class="w3-row-padding" style="margin:0 -16px;">
          <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-calendar-o"></i>대여일</label>
            <input class="w3-input w3-border" type="text" placeholder="YYYY/MM/DD" name="CheckIn" required>
          </div>
          <div class="w3-half">
            <label><i class="fa fa-calendar-o"></i> 반납일</label>
            <input class="w3-input w3-border" type="text" placeholder="YYYY/MM/DD" name="CheckOut" required>
          </div>
        </div>
        <div class="w3-row-padding" style="margin:8px -16px;">
          <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-male"></i>대여지점</label>
            <!-- <input type="number" value="1" name="Adults" min="1" max="6"> -->
          	<select  class="w3-input w3-border" id="place" name="place">
			  <option value="강남지점">강남지점</option>
			  <option value="관악지점">관악지점</option>
			  <option value="구로지점">구로지점</option>
			  <option value="여의도지점">여의도지점</option>
			  <option value="홍대지점">홍대지점</option>
			</select>
          
          </div>
          <div class="w3-half">
            <label><i class="fa fa-child"></i>인원수</label>
          <input class="w3-input w3-border" type="number" value="0" name="Kids" min="0" max="6">
          </div>
        </div>
        <button class="w3-button w3-dark-grey" type="submit"><i class="fa fa-search w3-margin-right"></i>예약하기</button>
      </form>
    </div>
  </div>
</header>
...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      <img src="image/room_single.jpg" alt="Norway" style="width:100%">
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="image/room_double.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Double Room</h3>
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="image/room_deluxe.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Deluxe Room</h3>
  ...
  <div class="w3-row-padding" id="about">
    ...
    <div class="w3-col l8 12">
      ...
      <img src="image/map.jpg" class="w3-image w3-greyscale" style="width:100%;">
    </div>
  </div>
